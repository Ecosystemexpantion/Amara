...
// Send a voice note generated by ElevenLabs TTS.
// Falls back to plain sendMessage if ELEVENLABS_API_KEY is not set or on any error.
export async function sendVoiceNote(chatId: number | string, text: string): Promise<void> {
  ...
  try {
    // Show "recording voice" indicator while TTS is being generated
